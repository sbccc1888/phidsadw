...
window.addEventListener("DOMContentLoaded", () => {
	...
	songInfoXHR.open(
		"GET",
		"https://github.com/sbccc1888/phitest-charts-repo/" + play + "/meta.json",
		true
	);
	songInfoXHR.addEventListener("load", () => {
		...
		document.body.setAttribute(
			"style",
			`--background:url(https://github.com/sbccc1888/phitest-charts-repo/${playResult.play}/${playResult.songInfo.illustration});`
		);
		document
			.querySelector("#songImg")
			.setAttribute(
				"src",
				"https://github.com/sbccc1888/phitest-charts-repo/" +
					play +
					"/" +
